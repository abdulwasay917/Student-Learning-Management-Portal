...
class AssignmentSerializer(serializers.ModelSerializer):
    ...
    teacher_name = serializers.CharField(source="created_by.name",read_only=True    )
    ...
    class Meta:
        ...
        fields = ["id","title","statement","teacher_name","creator_id","submitted_count","submitted","created_at",]

        read_only_fields = ["id","teacher_name","submitted_count","created_at",]
